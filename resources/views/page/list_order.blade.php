...
@endif
@endforeach
<div class="col-md-12 chitietnguoi ola">
        <label for="">Thông tin tài khoản đặt phòng</label>
        <br>
        <div class="form-group row">
            <label for="">Tài khoản đặt phòng : </label>
    ...
    <div class="col-md-12 chitietnguoi">
        <label for="">Thông tin người đến nhận phòng</label>
        <br>
        <div class="form-group row">
